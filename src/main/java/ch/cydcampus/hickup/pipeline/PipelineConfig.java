...
import ch.cydcampus.hickup.pipeline.feature.combinationrules.LS24InternalCombinationRule;
...
import ch.cydcampus.hickup.pipeline.filter.LS24Filter;
...
public class PipelineConfig {
    ...
    public static final FeatureCombinationRule[][] FEATURE_COMBINATION_RULES = {
        {new LS24InternalCombinationRule().setOutputIndex(9)},
        {}
    };
    ...
    public static final FilterRule[][] FILTER_RULES = {
        {new HighPassSizeFilter(100), new LS24Filter(9)},
        {}
    };
