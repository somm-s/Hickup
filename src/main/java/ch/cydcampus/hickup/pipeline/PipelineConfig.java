...
public class PipelineConfig {
    ...
    public static final String[] LEVEL_1_FEATURES = new String[] {"hostPairID", "bytes"};
    public static final FeatureType[] LEVEL_1_FEATURE_TYPES = new FeatureType[] {FeatureType.STRING, FeatureType.LONG};
    public static final String[] LEVEL_2_FEATURES = new String[] {"bytes"};
    public static final FeatureType[] LEVEL_2_FEATURE_TYPES = new FeatureType[] {FeatureType.LONG};
