...
public class PipelineConfig {
    ...
    public static final String[] LEVEL_2_FEATURES = new String[] {"hostPairID", "bytes", "intervalLength", "numChildren"};
    public static final FeatureType[] LEVEL_2_FEATURE_TYPES = new FeatureType[] {FeatureType.STRING, FeatureType.LONG, FeatureType.LONG, FeatureType.INT};
    ...
    public static final FeatureCombinationRule[][] FEATURE_COMBINATION_RULES = {
        ...
        { new IntervalLengthCombinationRule().setOutputIndex(2), new ChildrenCountCombinationRule().setOutputIndex(3)},
        {}
    };
