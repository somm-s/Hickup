...
public class IntervalLengthCombinationRule implements FeatureCombinationRule {
    ...
    public void combine(Abstraction abstraction) {
        abstraction.getFeature(outputIndex).set(abstraction.getLastUpdateTime() - abstraction.getFirstUpdateTime());
    }
